...
| Command                | Description              |
|------------------------+--------------------------|
| scimax.agenda.week    | Next 7 days              |
...
| Command                  | Description              |
|--------------------------+--------------------------|
| scimax.agenda.month     | Next 30 days             |
...
| Command                   | Description                    |
|---------------------------+--------------------------------|
| scimax.agenda.todoList   | All TODO items (native)        |
...
| Command                    | Description                     |
|----------------------------+---------------------------------|
| scimax.agenda.deadlines   | Show upcoming deadlines         |
...
| Command                      | Description                    |
|------------------------------+--------------------------------|
| scimax.agenda.scheduled     | All scheduled items            |
...
See [[file:timestamps.org][Timestamps]] for more on repeaters.
...
| Command                          | Description                  |
|----------------------------------+------------------------------|
| scimax.agenda.filterByTag       | Filter by tag (native)       |
| scimax.db.searchByTag           | Filter by tag (database)     |
...
* ⚠️ Navigating and Acting on Items
...
** ⚠️ Indexing for Agenda

Before using database agenda, index your files:

| Command                 | Description                    |
|-------------------------|--------------------------------|
| scimax.db.reindex      | Index all org files            |
...
See [[file:database-search.org][Database Search]] for more on database queries.
...
1. Run scimax.agenda.deadlines or scimax.db.deadlines
...
* ⚠️ Agenda Best Practices

** ⚠️ Keep Agenda Files Organized
...
2. *Verify day of week*:
   - Day must match date
   - Use Shift+Right to recalculate
...
- [[file:todo-items.org][TODO Items]] - Creating and managing TODO items
- [[file:timestamps.org][Timestamps]] - Date formats, scheduling, deadlines, repeaters
- [[file:document-structure.org][Document Structure]] - Organizing headlines and content
- [[file:database-search.org][Database Search]] - Advanced search and filtering
- [[file:configuration.org][Configuration]] - Extension settings
- [[file:getting-started.org][Getting Started]] - Basic usage guide

* Navigation

- Previous: [[file:image-overlays.org][Image Overlays]]
- Next: [[file:journal.org][Journal]]
