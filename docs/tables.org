...
** ⚠️ Adding/Removing Rows

| Key/Command                   | Action                        |
|-------------------------------+-------------------------------|
| Alt+Enter or Shift+Enter   | Insert row below              |
| scimax.table.insertRowAbove  | Insert row above current      |
| scimax.table.insertRowBelow  | Insert row below current      |
| Alt+Shift+Backspace          | Delete current row            |
