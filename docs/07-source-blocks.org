...
Today is src_python[:results value]{import datetime; datetime.date.today()} {{{results(=datetime.date(2026, 1, 18)=)}}}.

*** ✅ Accessing Variables
CLOSED: [2026-01-17 Sat 14:34]
...
The total with tax is src_python[:session *calc*]{return total * (1 + tax_rate)} {{{results(=108.0=)}}}.
...
** ✅ Inline Call Syntax
CLOSED: [2026-01-17 Sat 14:24]

You can also call blocks inline:


The square of 7 is call_square(x=7) {{{results(=49=)}}}.
