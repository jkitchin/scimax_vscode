...
:    - [[file:01-getting-started.org::90][** ⚠️ Updating the Extension]]
: 
: ** [[file:18-database-search.org][18-database-search.org]] (1 items)
:    - [[file:18-database-search.org::388][* ⚠️ Advanced Search (SOTA Pipeline)]]
: 
: ** [[file:23-speed-commands.org][23-speed-commands.org]] (1 items)
:    - [[file:23-speed-commands.org::179][*** 👀 Sorting Entries (^)]]
: 
: Total: 3 items need review
