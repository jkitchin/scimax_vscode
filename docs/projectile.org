...
** ⚠️ Creating a Projectile Marker
...
This delegates to VS Code's built-in quick open (Ctrl+P), which automatically scopes to workspace folders.
...
* ⚠️ Integration with Notebook System

** ⚠️ Notebook-Projectile Relationship
...
** ⚠️ Creating Projectile-Enabled Notebooks
...
** ⚠️ Converting Projects to Notebooks
...
** ⚠️ Notebook Metadata in Projects
...
** ⚠️ Workflow Example: Research Projects
...
*** ⚠️ When to Use Separate Windows
...
** ⚠️ Scanning Not Finding Projects
...
* ⚠️ Comparison with Emacs Projectile
...
- *VS Code*: Uses built-in Quick Open (Ctrl+P)
...
*** ⚠️ Buffer Management
- *Emacs*: C-c p b switch buffer within project
- *VS Code*: Not needed (tabs and Quick Open serve this role)

*** ⚠️ Project Commands
- *Emacs*: Many specialized commands (C-c p c compile, C-c p t test)
...
- [[file:notebook.org][Notebook (Project Organization)]] - Research project structure with notebooks
- [[file:keybindings.org][Keybindings]] - Complete keybinding reference
- [[file:configuration.org][Configuration]] - Extension settings and customization
