...
1. *Quick capture everything*: Use `C-c c' → `i' to capture to inbox
...
See [[file:14-journal.org][Journal Documentation]] for details.

** Agenda Integration

Captured TODO items with timestamps appear in the agenda view.

See [[file:13-agenda.org][Agenda Documentation]] for details.

** Database Search

All captured content is indexed and searchable via the database.

See [[file:18-database-search.org][Database Search Documentation]] for details.
...
- [[file:03-todo-items.org][TODO Items Documentation]]
...
- Previous: [[file:14-journal.org][Journal]]
- Index: [[file:00-index.org][Documentation Index]]
- Next: [[file:16-notebook.org][Notebook]]
