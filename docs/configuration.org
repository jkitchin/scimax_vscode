...
1. *Settings UI*: Press Ctrl+, (or Cmd+, on macOS) to open the VS Code settings interface. Search for "scimax" to see all Scimax-related settings.

2. *settings.json*: Edit your settings file directly for more control:
   - Press Ctrl+Shift+P (or Cmd+Shift+P) and search for "Preferences: Open Settings (JSON)"
...
*** ⚠️ scimax.ref.bibliographyFiles
...
*** ⚠️ scimax.export.latex.customHeader
...
*** ⚠️ scimax.latexPreview.cacheEnabled
...
*** ⚠️ scimax.latexPreview.darkModeAware
...
*** ⚠️ scimax.latexLivePreview.buildOnSave
...
*** ⚠️ scimax.latexLivePreview.buildOnIdle
...
*** ⚠️ scimax.latexLivePreview.idleDelay
...
*** ⚠️ scimax.latexLivePreview.compiler
...
*** ⚠️ scimax.latexLivePreview.useLatexmk
...
*** ⚠️ scimax.notebook.defaultTemplate
...
*** ⚠️ scimax.speedCommands.enabled
...
*** ⚠️ scimax.agenda.excludePatterns
...
*** ⚠️ scimax.imageOverlays.enabled
...
*** ⚠️ scimax.imageOverlays.maxWidth
...
*** ⚠️ scimax.imageOverlays.maxHeight
...
*** ⚠️ scimax.imageOverlays.renderMode
...
*** ⚠️ scimax.imageOverlays.onlyWhenCursorNotInLink
...
*** ⚠️ scimax.imageOverlays.excludePatterns
...
*** ⚠️ scimax.imageOverlays.maxOverlaysPerDocument
...
*** ⚠️ scimax.imageOverlays.showDimensions
...
*** ⚠️ scimax.imageOverlays.cacheEnabled
...
*** ⚠️ scimax.capture.datetreeFormat
...
Then manually trigger indexing with Ctrl+Shift+P -> "Scimax: Reindex Files"

** ⚠️ Jupyter Kernels Not Found
...
Check available kernels with Ctrl+Shift+P -> "Scimax: Show Available Jupyter Kernels"
...
- [[file:source-blocks.org][Source Blocks Documentation]]
- [[file:export.org][Export Documentation]]
