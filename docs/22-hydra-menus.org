...
All hydra commands can be invoked through the command palette (C-S-P):
...
Configure hydra behavior through VS Code settings (File > Preferences > Settings or C-,):
