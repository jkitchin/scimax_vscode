...
** ⚠️ Insert Timestamp Command

| Key/Command               | Action                          |
|---------------------------+---------------------------------|
| Ctrl+C .                 | Insert active timestamp         |
| Ctrl+C !                 | Insert inactive timestamp       |
| Speed key .              | Insert timestamp (at heading)   |

Press Ctrl+C . and a date picker dialog appears. You can:
...
,* Meeting notes
  [2026-01-14 Tue 10:00]   ; Press Ctrl+C !
#+END_SRC

* ⚠️ Modifying Timestamps

** ⚠️ Adjusting Dates with Keyboard

Place cursor on a timestamp component and use:

| Key           | Action                              |
|---------------+-------------------------------------|
| Shift+Up     | Increase value (day, month, year)   |
| Shift+Down   | Decrease value                      |
| Shift+Right  | Move to next day                    |
| Shift+Left   | Move to previous day                |

** ⚠️ Component-Based Editing
...
- On year: Shift+Up/Down changes year
- On month: Shift+Up/Down changes month
- On day: Shift+Up/Down or Shift+Left/Right changes day
- On hour: Shift+Up/Down changes hour
- On minute: Shift+Up/Down changes minute

** ⚠️ Quick Date Adjustment Examples
...
** ⚠️ Adding SCHEDULED and DEADLINE
...
| Key/Command             | Action                            |
|-------------------------+-----------------------------------|
| Speed key Shift+I      | Clock in (start timer)            |
| Speed key Shift+O      | Clock out (stop timer)            |
...
3. Press Shift+I - clock in
4. Work on task...
5. Press Shift+O - clock out
...
Timestamps work seamlessly with TODO items. See [[file:todo-items.org][TODO Items]] for more on task
management.
...
See [[file:agenda.org][Agenda]] for details on agenda views.
...
| Ctrl+C .          | Insert active timestamp          |
| Ctrl+C !          | Insert inactive timestamp        |
| Shift+Up          | Increase timestamp component     |
| Shift+Down        | Decrease timestamp component     |
...
- [[file:todo-items.org][TODO Items]] - Task management with timestamps
- [[file:agenda.org][Agenda]] - Viewing scheduled tasks and deadlines
- [[file:document-structure.org][Document Structure]] - Headlines and organization
- [[file:getting-started.org][Getting Started]] - Basic Scimax VS Code usage

* Navigation

- Previous: [[file:links.org][Links]]
- Next: [[file:source-blocks.org][Source Code Blocks]]
