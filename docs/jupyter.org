...
** ⚠️ What Jupyter Integration Provides
...
*** ⚠️ When to Use Native Executors
...
** ⚠️ Installing Kernels

*** ⚠️ Python (IPython Kernel)
...
* ⚠️ Using Jupyter Kernels

** ⚠️ Basic Execution

*** ⚠️ Explicit Jupyter Syntax
...
** ⚠️ Rich Output and Visualization
...
#+RESULTS:
[[.ob-jupyter/output-1705171200000-0.png]]
#+END_SRC

The image is automatically linked in the results, and you'll see it rendered in
VS Code's org-mode preview.

**** ⚠️ Julia Plots Example

#+BEGIN_SRC org
#+BEGIN_SRC jupyter-julia :session :results file
using Plots
x = 0:0.1:2π
...
#+RESULTS:
[[.ob-jupyter/output-1705171200001-0.png]]
#+END_SRC

**** ⚠️ R Graphics Example
...
#+RESULTS:
[[.ob-jupyter/output-1705171200002-0.png]]
#+END_SRC
...
#+BEGIN_SRC org
#+BEGIN_SRC jupyter-python :dir /path/to/project
import os
print(os.getcwd())  # Prints: /path/to/project
#+END_SRC
#+END_SRC
...
#+BEGIN_SRC jupyter-python :var data=people-data
...
#+BEGIN_SRC org
#+BEGIN_SRC jupyter-python :file my-plot.png
import matplotlib.pyplot as plt
plt.plot([1, 2, 3], [1, 4, 9])
...
*** ⚠️ Less Common Header Arguments
...
#+BEGIN_SRC org
#+BEGIN_SRC jupyter-python :prologue "import numpy as np" :epilogue "print('Done')"
...
*** ⚠️ Selecting a Specific Kernel

*Command:* Jupyter: Show Available Kernels
...
** ⚠️ Viewing Running Kernels

*Command:* Jupyter: Show Running Kernels
...
1. Check the Jupyter output channel for error messages:
   - View → Output → Select "Jupyter Kernels"
...
** ⚠️ Complete Data Analysis Example
...
** ⚠️ Julia Scientific Computing Example
...
** ⚠️ R Statistical Analysis Example
...
- [[file:source-blocks.org][Scimax Source Blocks Documentation]]
...
- [[file:source-blocks.org][Source Code Blocks]] - Code execution and header arguments
- [[file:supported-languages.org][Supported Languages]] - All available languages
- [[file:configuration.org][Configuration]] - Jupyter settings
- [[file:image-overlays.org][Image Overlays]] - Displaying Jupyter output images

* Navigation

- Previous: [[file:supported-languages.org][Supported Languages]]
- Next: [[file:export.org][Export]]
