...
|------------------------------+------------------+--------------------------------|
| scimax.org.nextHeading     | -                | Jump to next heading           |
| scimax.org.previousHeading | -                | Jump to previous heading       |
| scimax.org.parentHeading   | -                | Jump to parent heading         |
| scimax.org.jumpToHeading   | C-c C-j        | Fuzzy search headings          |

*** ⚠️ Next/Previous Heading
...
** ⚠️ Source Block Navigation

Navigate between source blocks in org documents:

| Command                   | Key Binding | Description               |
|---------------------------+-------------+---------------------------|
| scimax.ob.nextBlock     | -           | Jump to next source block |
| scimax.ob.previousBlock | -           | Jump to previous block    |
| scimax.ob.jumpToBlock   | -           | Fuzzy search blocks       |
| scimax.ob.jumpToResults | -           | Jump to results section   |

*** ⚠️ Next/Previous Source Block
...
** ⚠️ Sibling Navigation (Speed Commands)
...
| Command                       | Key Binding       | Description                     |
|-------------------------------+-------------------+---------------------------------|
| scimax.fuzzySearchOpenFiles | C-c S-s         | Search lines in all open files  |
...
** ⚠️ Search Outline (Headings/Symbols)
...
| Command                 | Key Binding | Description                        |
|-------------------------+-------------+------------------------------------|
| scimax.jump.gotoChar  | -           | Jump to any character              |
| scimax.jump.gotoChar2 | -           | Jump to 2-character sequence       |
...
| Command                | Key Binding | Description                        |
|------------------------+-------------+------------------------------------|
| scimax.jump.gotoWord | -           | Jump to word starts                |
...
| Command                | Key Binding | Description                        |
|------------------------+-------------+------------------------------------|
| scimax.jump.gotoLine | -           | Jump to any visible line           |
...
| Command                  | Key Binding | Description                        |
|--------------------------+-------------+------------------------------------|
| scimax.jump.gotoSymbol | -           | Jump to symbols and headings       |
...
| Command                   | Key Binding | Description                        |
|---------------------------+-------------+------------------------------------|
| scimax.jump.gotoSubword | -           | Jump to subword boundaries         |
...
| Command                        | Key Binding      | Description                |
|--------------------------------+------------------+----------------------------|
| workbench.action.navigateBack | Alt+Left / C-c [ | Go to previous location |
| workbench.action.navigateForward | Alt+Right / C-c ] | Go to next location  |
...
* ⚠️ Tips and Workflows

** ⚠️ Quick Heading Navigation
...
** ⚠️ Speed Commands Not Triggering
...
** ⚠️ Navigation History Not Working
