...
- =Ctrl+C e ]= → next (forward, like closing bracket points right)
- =Ctrl+C e [= → previous (backward, like opening bracket points left)
...
- Previous: [[file:references.org][References]]
- Next: [[file:navigation.org][Navigation]]
