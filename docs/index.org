...
- [[file:granular-addressing.html][Granular Addressing (Anchors and Back-links)]]
- [[file:notes.html][Dialog Notes (Decisions, Questions, Comments)]]
- [[file:tables.html][Tables]]
* Task Management

- [[file:todo-items.html][TODO Items and Task Management]]
- [[file:task-dependencies.html][Task Dependencies]]
- [[file:project-management.html][Project Management (Tables, Gantt, People)]]
- [[file:cli.html::#tasks][Tasks from the Command Line (=scimax task=)]]
- [[file:contacts-and-locations.html][Contacts, Locations & Entity Selector]]
...
- [[file:export-beamer.html][Beamer Export]]
...
- [[file:find-file.html][Find File (C-x C-f)]]
- [[file:hydra-menus.html][Hydra Menus]]
- [[file:editmarks.html][Editmarks (Track Changes)]]
- [[file:commands.html::#rectangle][Rectangle Commands (Emacs-style)]]
* Reference

- [[file:org-api.html][Org API]]
- [[file:cli.html][Command Line Interface (CLI)]]
* Development

- [[file:extension-points.html][Extension Points for Plugin Development]]