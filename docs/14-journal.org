...
** ✅ Keyboard Navigation
CLOSED: [2026-01-17 Sat 15:11]

When viewing a journal entry:

- C-Cmd-[ - Go to previous entry
- C-Cmd-] - Go to next entry

These shortcuts only work when the current file is a journal entry (filename matches YYYY-MM-DD.org or .md).

** ✅ Go to Specific Date
CLOSED: [2026-01-17 Sat 14:05]

Run Scimax: Go to Journal Date to see a list of all your entries: [[cmd:scimax.journal.goto]]
...
** ✅ Calendar View
CLOSED: [2026-01-17 Sat 14:06]

The calendar view provides a visual way to navigate entries:

*** ✅ Accessing the Calendar

- Look for "Journal Calendar" in the Scimax sidebar (Activity Bar)
- Or run: Scimax: Show Journal Calendar [[cmd:scimax.journal.calendar]]

*** ✅ Calendar Features
CLOSED: [2026-01-18 Sun 12:06]

The calendar shows:

- Current month with clickable days
- Days with entries are highlighted with a blue dot
...
** ✅ Week View
CLOSED: [2026-01-18 Sun 12:08]

To see all entries for the current week:

Run Scimax: This Week's Entries [[cmd:scimax.journal.weekView]]
...
CLOSED: [2026-01-17 Sat 14:17]

** ✅ Quick Log Entry
CLOSED: [2026-01-17 Sat 14:18]
...
The journal directory is automatically indexed in the database by
default (via =scimax.db.includeJournal=). Because the agenda is a view
over the database, journal entries appear in agenda and TODO views
without further configuration.

To pick up changes (especially edits made on another machine via
Dropbox sync), run =Scimax: Refresh Database (incremental)=
([[cmd:scimax.db.refresh]]).
