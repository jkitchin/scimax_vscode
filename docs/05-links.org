...
Two commands pull link targets from other macOS apps via AppleScript and
insert them at the cursor as org-mode links.
...
Both commands require macOS. On first run, macOS will prompt you to grant
VS Code permission to control Finder / Google Chrome via Automation
...
- [[file:42-granular-addressing.org][Granular Addressing]] - Anchors, cross-file resolution, back-links, and orphan diagnostics
