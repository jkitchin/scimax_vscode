...
When exporting documents (HTML, LaTeX, PDF), editmarks are *not* processed - they appear as raw text in the output (e.g., =@@+inserted text+@@=).

*Recommendation*: Accept or reject all editmarks before final export using:
- =C-c e a= - Accept all marks
- =C-c e r= - Reject all marks
