...
| [[cmd:scimax.markup.underline]]        | Underline (Markup)          | C-c u              |
...
| Command ID                         | Description              | Default Keybinding |
|------------------------------------+--------------------------+--------------------|
| [[cmd:scimax.help.describeCommand]]| Describe Command         | -                  |
| [[cmd:scimax.help.describeKey]]    | Describe Key             | -                  |
| [[cmd:scimax.help.listKeybindings]]| List All Keybindings     | -                  |
...
Emacs-style mark and point stack for navigation and selection. These commands allow you to save positions (marks) and return to them later, similar to Emacs' mark ring functionality.
...
- **Mark Ring**: A stack of marks (per-buffer), most recent first
- **Global Mark Ring**: A cross-file stack of marks

** Common Workflows

*** Setting a Mark for Selection
1. Press =C-SPC= to set mark at current position
2. Move cursor to end of desired selection
3. Region between mark and point is now selected

*** Returning to Previous Positions
1. Press =C-SPC C-SPC= to push mark without activating selection
2. Navigate elsewhere in the file
3. Press =C-u C-SPC= to return to the saved mark

*** Cross-file Navigation
1. Navigate to different files; each jump pushes to global ring
2. Press =C-x C-SPC= to jump back through global mark history
