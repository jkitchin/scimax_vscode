...
| [[cmd:scimax.org.refile]]           | Refile Subtree         | C-c C-w            |
| [[cmd:scimax.org.refileCopy]]       | Copy Subtree to Target | C-c M-w            |
| [[cmd:scimax.org.markSubtree]]      | Mark (Select) Subtree  | m (speed)          |
| [[cmd:scimax.org.addIdToHeading]]   | Add ID to Heading      | -                  |

** ✅ Granular Addressing (Anchors)
CLOSED: [2026-07-02 Thu 08:03]
...
excluded from exports. See [[file:43-notes.org][Dialog Notes]].
...
Express dependencies between TODO tasks (org-depend style). See
[[file:03.5-task-dependencies.org][Task Dependencies]] for the full guide.
...
** ✅ Project Management
CLOSED: [2026-07-11 Sat 09:59]

Task tables, Gantt charts, a dependency graph, and a people database. See
[[file:03.6-project-management.org][Project Management]] for the full guide.
...
Fuzzy-pick a tagged/propertied heading (contact, location, reagent, …) and act
on it. See [[file:03.7-contacts-and-locations.org][Contacts, Locations & Entity Selector]].
...
| [[cmd:scimax.table.moveCellUp]]        | Move Table Cell Up        | C-M-UP (in table)    |
| [[cmd:scimax.table.moveCellDown]]      | Move Table Cell Down      | C-M-DOWN (in table)  |
| [[cmd:scimax.table.moveCellLeft]]      | Move Table Cell Left      | C-M-LEFT (in table)  |
| [[cmd:scimax.table.moveCellRight]]     | Move Table Cell Right     | C-M-RIGHT (in table) |
...
in =latex-profiles.json= or settings. See [[file:10-export.org::*Build Profiles][Build Profiles documentation]].
...
** 👀 Custom Exporters
CLOSED: [2026-01-24 Sat 17:42]

User-defined export backends using Handlebars templates. See [[file:extension-points.org::*Custom Exporters][Custom Exporters documentation]].

Loaded exporters are also listed in the export dispatcher (=C-c C-e=) under
=[c 1]=, =[c 2]=, ..., with =[c c]= opening the picker.

| Command ID                                  | Description                      | Default Keybinding |
|---------------------------------------------+----------------------------------+--------------------|
| [[cmd:scimax.export.custom]]                | Export with Custom Exporter      | - (C-c C-e, =c c=) |
...
| [[cmd:scimax.export.showExporterProblems]]  | Show Custom Exporter Problems    | -                  |
| [[cmd:scimax.export.insertExporterHeader]]  | Insert Custom Exporter Header    | -                  |
...
| [[cmd:scimax.agenda.ignoreFileFromItem]]| Ignore File from Agenda Item | -            |
| [[cmd:scimax.agenda.ignoreFileFromTab]] | Ignore File from Editor Tab  | -            |
| [[cmd:scimax.agenda.unignoreFile]]    | Unignore File in Agenda  | -                  |
| [[cmd:scimax.agenda.openBuffer]]      | Open Agenda Buffer       | C-c a v            |
| [[cmd:scimax.agenda.buffer.goto]]     | Agenda Buffer - Go to Item   | RET (in buffer) |
| [[cmd:scimax.agenda.buffer.refresh]]  | Agenda Buffer - Refresh      | g (in buffer)   |
| [[cmd:scimax.agenda.buffer.next]]     | Agenda Buffer - Next Period  | f (in buffer)   |
| [[cmd:scimax.agenda.buffer.previous]] | Agenda Buffer - Prev Period  | b (in buffer)   |
| [[cmd:scimax.agenda.buffer.today]]    | Agenda Buffer - Back to Today | . (in buffer)  |
| [[cmd:scimax.agenda.buffer.cycleTodo]]| Agenda Buffer - Cycle TODO State | t (in buffer) |
...
| [[cmd:scimax.ref.insertCitationForKey]] | Insert Citation for Key    | - (used by hover)    |
...
| [[cmd:scimax.fuzzySearchRecentFiles]]  | Fuzzy Search (Recent org/md)     | C-x b              |
...
| [[cmd:scimax.jump.gotoCharTimer]] | Jump to Text (Timer)         | C-c j t               |
...
| [[cmd:scimax.jump.gotoHeading]]   | Jump to Heading              | C-c j h               |
| [[cmd:scimax.jump.copyLine]]      | Jump Copy Line               | -                     |
| [[cmd:scimax.jump.killLine]]      | Jump Kill Line               | -                     |
| [[cmd:scimax.jump.listCommands]]  | Jump Commands (menu)         | C-c j ?               |
| [[cmd:scimax.jump.cancel]]        | Jump Cancel                  | Escape (in a jump)    |
| [[cmd:scimax.jump.backspace]]     | Jump Delete Last Character   | Backspace (in a jump) |
...
| Command ID                       | Description         | Default Keybinding |
|----------------------------------+---------------------+--------------------|
| [[cmd:scimax.recenterTopBottom]] | Recenter Top Bottom | C-l                |

Emacs-style =recenter-top-bottom=. Pressing =C-l= repeatedly while the cursor
stays put cycles the cursor line through three scroll positions: center on the
first press, top on the second, bottom on the third, then back to center.
Moving the cursor or switching editors resets the cycle to center.
...
*Note:* On macOS, the first time you use =F10= for screenshots, you may need to grant screen recording permission to VS Code in System Settings > Privacy & Security > Screen Recording, then restart VS Code. See [[file:12-image-overlays.org::*Inserting Screenshots][Inserting Screenshots]] for details.
...
1. Fetches the latest release from the [[https://github.com/jkitchin/scimax_vscode][GitHub repository]]
...
- [[file:24-keybindings.org::*Rectangle Commands (Emacs-style)][Keybinding Reference: Rectangle Commands]]
- [[file:22-hydra-menus.org][Hydra Menus]] - Rectangle commands are available in the Hydra menu system
...
| [[cmd:scimax.openTerminalHere]]    | Open Integrated Terminal in Dir       | -                  |
| [[cmd:scimax.openExternalTerminalHere]] | Open External Terminal in Dir    | -                  |
...
See [[file:37-dired.org][Dired documentation]] for full details.
