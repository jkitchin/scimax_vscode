...
#+RESULTS:
: Error: OSError: [Errno 30] Read-only file system: 'data.csv'
...
#+RESULTS:
[[file:.ob-jupyter/output-1768614615341-0.png]]
...
#+RESULTS:
: Error: SyntaxError: invalid syntax (676924641.py, line 1)
...
#+RESULTS:
: Error: SyntaxError: expression cannot contain assignment, perhaps you meant "=="? (1493372202.py, line 1)
#+END_SRC
...
#+RESULTS:
: Error: OSError: [Errno 30] Read-only file system: 'my-plot.png'
#+END_SRC
