...
Note: If you previously had =scimax.db.openaiApiKey= in your settings.json, it will be automatically migrated to secure storage and removed from settings on first run.
