...
* ⚠️ Introduction to Literate Programming
...
** ⚠️ Benefits of Literate Programming
...
** ⚠️ Literate Programming in Org-Mode
...
| Command                           | Description                         |
|-----------------------------------+-------------------------------------|
| scimax.org.executeBlock          | Execute the current source block    |
| scimax.ob.executeAndNext         | Execute and jump to next block      |
| scimax.ob.executeToPoint         | Execute all blocks up to cursor     |
| scimax.ob.executeAll             | Execute all blocks in document      |
| scimax.babel.executeAllBlocks    | Execute all blocks in document      |
...
#+BEGIN_SRC org
#+BEGIN_SRC language :arg1 value1 :arg2 value2
code
#+END_SRC
#+END_SRC
...
*** ⚠️ :results - Control Output Format
...
*** ⚠️ :exports - Control What Gets Exported
...
** ⚠️ Variable Arguments

*** ⚠️ :var - Pass Variables to Code
...
#+BEGIN_SRC org
#+BEGIN_SRC python :var x=10 :var y=20
result = x + y
print(f"{x} + {y} = {result}")
#+END_SRC
...
*** ⚠️ :session - Enable Stateful Execution
...
** ⚠️ Directory Arguments

*** ⚠️ :dir - Set Working Directory
...
** ⚠️ Tangling Arguments

*** ⚠️ :tangle - Extract Code to Files
...
*** ⚠️ :cache - Cache Execution Results
...
*** ⚠️ :prologue and :epilogue - Code Injection
...
*** ⚠️ :cmdline - Command Line Arguments
...
* ⚠️ Results Handling and Output Types

** ⚠️ Automatic Result Insertion
...
** ⚠️ Result Types by Language

*** ⚠️ Text Output (Verbatim)
...
* ⚠️ Sessions for Stateful Execution
...
plt.savefig('.ob-jupyter/hist.png')
#+END_SRC
#+END_SRC

** ⚠️ Benefits of Sessions
...
** ⚠️ Block Navigation Keybindings
...
*** ⚠️ Insert Block Above

| Command                         | Description                      |
|---------------------------------+----------------------------------|
| scimax.ob.insertBlockAbove     | Insert new block above cursor    |

Prompts for language, creates block, and places cursor inside.

*** ⚠️ Insert Block Below

| Command                         | Description                      |
|---------------------------------+----------------------------------|
| scimax.ob.insertBlockBelow     | Insert new block below cursor    |
...
| Command                    | Description                           |
|----------------------------|---------------------------------------|
| scimax.ob.splitBlock      | Split current block at cursor         |
...
** ⚠️ Emacs Org-Mode Documentation
